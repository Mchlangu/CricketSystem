<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HiredProducts.aspx.cs" Inherits="CricketSystem.Admin.HiredProducts" %>
    ...
    <div class="form">
            ...
            <asp:Button ID="btnSearch" runat="server" Text="Search" OnClick="btnSearch_Click" />
                <div id="dvGrid" style ="padding:10px;width:100%; position:relative; margin:0; display:block;">
                           ...
                           <Columns>
                         <asp:TemplateField HeaderText = "Hire ID.">
                                <ItemTemplate>
                                    <asp:Label ID="lblOrder_no" runat="server" Text='<%# Eval("Hire_id")%>'></asp:Label>
                                </ItemTemplate> 
                         </asp:TemplateField> 
                            ...
                            <asp:TemplateField  HeaderText = "">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lblViewOrder" runat="server" Text="View Details" ForeColor="DodgerBlue" CommandArgument = '<%# Eval("Hire_id")%>' OnCommand="OpenModal"></asp:LinkButton>
                                </ItemTemplate>
                            <ItemStyle></ItemStyle>
                            </asp:TemplateField>
                           </Columns> 
      ...
      <asp:Panel ID="pnlpopup" runat="server" BackColor="White" style="width:50%; height:auto; z-index:111;background-color: White; position: absolute; left: 25%; top: 12%; border: outset 2px gray;padding:5px;display:none; min-width:300px">
            ...
            <tr><td><h3>Hire ID. <asp:label ID="lblOrderNo" runat="server" /></h3></td></tr>
