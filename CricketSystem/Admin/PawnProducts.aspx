<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PawnProducts.aspx.cs" Inherits="CricketSystem.Admin.PawnProducts" %>
                    ...
                    <div id="dvProdGrid" style ="padding:10px;width:100%; position:relative; margin:0; display:block;">
                           ...
                           <Columns>
                            <asp:TemplateField HeaderText = "ID">
                                <ItemTemplate>
                                    <asp:Label ID="lblProd_Id" runat="server" Text='<%# Eval("Pawn_Product_id")%>'></asp:Label>
                                </ItemTemplate> 
                         </asp:TemplateField> 
                           ...
                           <ItemStyle></ItemStyle>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkRemove" runat="server" CommandArgument = '<%# Eval("Pawn_Product_id")%>' 
