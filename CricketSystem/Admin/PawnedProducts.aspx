<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PawnedProducts.aspx.cs" Inherits="CricketSystem.Admin.PawnedProducts" %>
...
<body data-spy="scroll" data-target="#navbar-example">
    ...
    <div class="form">
            ...
            <asp:TextBox ID="txtSearch" runat="server" placeholder="Search by Firsname"></asp:TextBox>
                ...
                <div id="dvGrid" style ="padding:10px;width:100%; position:relative; margin:0; display:block;">
                        ...
                        <Columns>
                         <asp:TemplateField HeaderText = "Pawn Id.">
                                <ItemTemplate>
                                    <asp:Label ID="lblPawnid" runat="server" Text='<%# Eval("Pawn_id")%>'></asp:Label>
                                </ItemTemplate> 
                         </asp:TemplateField> 
                            ...
                            <asp:TemplateField  HeaderText = "">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lblViewOrder" runat="server" Text="View Order" ForeColor="DodgerBlue" CommandArgument = '<%# Eval("Pawn_id")%>' OnCommand="OpenModal"></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                           </Columns> 
      ...
      <asp:Panel ID="pnlpopup" runat="server" BackColor="White" style="width:50%; height:auto; z-index:111;background-color: White; position: absolute; left: 25%; top: 12%; border: outset 2px gray;padding:5px;display:none; min-width:300px">
            ...
            <tr><td><h3>Pawn ID. <asp:label ID="lblOrderNo" runat="server" /></h3></td></tr>
