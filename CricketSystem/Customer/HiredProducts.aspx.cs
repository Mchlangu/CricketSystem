...
namespace CricketSystem.Customer
{
    public partial class HiredProducts : System.Web.UI.Page
    {
        ...
        private void BindDataOrders()
        {
            ...
            strQuery = "select Hire_No, Username,Date,Time from hired_table WHERE User_id = " + lblUsername.Text + " group by Hire_No, Username,Date,Time order by Hire_No desc";
        ...
        protected void DynamicalllAddList(int id)
        {
            ...
            SqlCommand cmd;
            SqlDataReader data;
            String query = "Select * from hired_table WHERE Hire_No = " + id + " ORDER BY Hire_No DESC";
