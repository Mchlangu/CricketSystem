<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HiredProducts.aspx.cs" Inherits="CricketSystem.Customer.HiredProducts" %>
			...
			<h2>Hired Products</h2>
                <div id="dvGrid" style ="padding:10px;width:100%; position:relative; margin:0; display:block;">
                         ...
                         <asp:TemplateField HeaderText = "Order No.">
                                <ItemTemplate>
                                    <asp:Label ID="lblOrder_no" runat="server" Text='<%# Eval("Hire_No")%>'></asp:Label>
                                </ItemTemplate> 
                         </asp:TemplateField> 
...
<%--                            <asp:TemplateField  HeaderText = "Status">
                            ...
                            <asp:TemplateField  HeaderText = "">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lblViewOrder" runat="server" Text="View Details" ForeColor="DodgerBlue" CommandArgument = '<%# Eval("Hire_No")%>' OnCommand="OpenModal"></asp:LinkButton>
                                </ItemTemplate>
                            <ItemStyle></ItemStyle>
                            </asp:TemplateField>
                           </Columns> 
