<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="CricketSystem.Customer.Index" EnableEventValidation="false" %>
...
<body data-spy="scroll" data-target="#navbar-example">
   ...
   <header>
    ...
    <div class="container" style="margin-top: 100px !important;">
       ...
       <p> Welcome Customer: <asp:Label ID="lblNames" runat="server" style="color:#ccc;" ></asp:Label> </p>   
