<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddProduct.aspx.cs" Inherits="CricketSystem.Supplier.AddProduct" %>
   ...
   <header>
    ...
    <div class="container" style="margin-top: 100px !important;">
     <div class="dropdown" style="color:midnightblue; display:block;float: right; font-weight:bold;margin-bottom: 20px;text-align:right;">
        <a href="SoldOrders.aspx">Orders</a>
         <br />
        <a href="#" style="text-decoration:underline">Add Product</a>
          <br />
        <a href="Products.aspx" >My Products</a>
    </div>
    ...
    <div class="form">
        ...
        <div class="form-group"> 
			<asp:TextBox  runat="server" ID="txtProductPrice" class="form-control" placeholder="Product Price" />
        </div>
        <div class="form-group"> 
			<asp:TextBox  runat="server" ID="txtProductNo" class="form-control" TextMode="Number" placeholder="No. of Products in Stock" />
        </div>        
        <div class="form-group"> 
