<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Products.aspx.cs" Inherits="CricketSystem.Supplier.Products" %>
    ...
    <div class="container" style="margin-top: 100px !important;">
     <div class="dropdown" style="color:midnightblue; display:block;float: right; font-weight:bold;margin-bottom: 20px;text-align:right;">
        ...
        <a href="AddProduct.aspx">Add Product</a>
          <br />
        <a href="#" style="text-decoration:underline">My Products</a>
    </div>
