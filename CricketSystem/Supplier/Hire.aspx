<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Hire.aspx.cs" Inherits="CricketSystem.Supplier.Hire" EnableEventValidation="false" %>
                ...
                <asp:GridView ID="grdProduct" runat="server" class="table" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="No. of days">
                            <ItemTemplate>
                                <asp:TextBox ID="txtNoDays" runat="server" style="width: 100px;padding-left: 10px;" TextMode="Number" Text='<%# Eval("days") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <ItemTemplate>
