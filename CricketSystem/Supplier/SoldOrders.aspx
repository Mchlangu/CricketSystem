<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SoldOrders.aspx.cs" Inherits="CricketSystem.Supplier.SoldOrders" %>
...
<body data-spy="scroll" data-target="#navbar-example">
    ...
    <div class="container" style="margin-top: 100px !important;">
     <div class="dropdown" style="color:midnightblue; display:block;float: right; font-weight:bold;margin-bottom: 20px;text-align:right;">
        <a href="#" style="text-decoration:underline">Orders</a>
         <br />
