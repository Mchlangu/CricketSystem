<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Orders.aspx.cs" Inherits="CricketSystem.Staff.Orders" %>
            ...
            <asp:Button ID="btnSearch" runat="server" Text="Search" OnClick="btnSearch_Click" />
                <div id="dvGrid" style ="padding:10px;width:100%; position:relative; margin:0; display:block;">
                         ...
                         <asp:TemplateField HeaderText = "Order ID.">
                                <ItemTemplate>
                                    <asp:Label ID="lblOrder_no" runat="server" Text='<%# Eval("Order_id")%>'></asp:Label>
                                </ItemTemplate> 
                         </asp:TemplateField> 
